...
| T16 | 調整月曆卡片欄寬與日期排版可讀性 | Completed | 已提高卡片最小寬度並固定日期欄排版 |
| T17 | 修正月曆檢視跨月資料卻只顯示單一月份標題 | Completed | 已依月份分組渲染並補上月曆測試 |
...
- 2026-03-12：開始進行 T16，準備調整月曆卡片欄寬與日期排版，避免桌機多欄擠壓。
- 2026-03-12：完成 T16，已提高月曆卡片最小寬度並固定日期欄，改善日期與標題擠壓問題。
- 2026-03-12：開始進行 T17，準備將月曆檢視改為依月份分組顯示並補上測試。
- 2026-03-12：完成 T17，已將月曆檢視改為按月份分組，避免 3 月標題下混入 4 月與 5 月活動。
